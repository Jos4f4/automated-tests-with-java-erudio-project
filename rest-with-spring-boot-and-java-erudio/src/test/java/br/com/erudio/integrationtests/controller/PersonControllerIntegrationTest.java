...
class PersonControllerIntegrationTest extends AbstractIntegrationTest {
	...
	@Test
	@Order(1)
	@DisplayName("JUnit intergration given Person Object when Create One Person Should Return a Person Object")
	...
	@Test
	@Order(2)
	@DisplayName("JUnit intergration given Person Object when Update One Person Should Return a Updated Person Object")
	...
	@Test
	@Order(3)
	@DisplayName("JUnit intergration given Person Object when findById Should Return a Person Object")
	...
	@Test
	@Order(5)
	@DisplayName("JUnit intergration when findAll Should Return a Persons List")
	void integrationTest_when_findAll_ShouldReturnAPersonsList() 
		...
		// Found the person 0 in the list
		...
		// Found the person 1 in the list
		...
		assertEquals("gabriela@erudio.com.br", foundPersonTwo.getEmail());	
	}
	
	@Test
	@Order(6)
	@DisplayName("JUnit intergration given Person Object when delete Should Return No Content")
